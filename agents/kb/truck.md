...
```json
{
  ...
  "steps": [
    ...
    { "order": 4, "agency": "DMV", "title": "Register the vehicle with the California DMV", "detail": "Current vehicle registration; proof of registration supports the Public Works application.", "deadline_days": 90, "deadline_label": "90-day document window", "cite": "ca-dmv", "autofill_field": "vehicle_plate", "status": "todo" },
